...
<div class="min-h-screen bg-white" style="padding-top: 40px;">
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="mb-12">
            <div>
                <h1 class="text-4xl font-bold text-gray-900">Laporan Harian</h1>
                <p class="text-gray-600 mt-2">Tanggal: <span class="font-semibold text-gray-900">{{ \Carbon\Carbon::parse($tanggal)->format('d F Y') }}</span></p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
            <div class="px-6 py-4" style="background: linear-gradient(135deg, #f9fafb 0%, #f3f4f6 100%); border-bottom: 2px solid #e5e7eb;">
                <h2 class="text-xl font-bold text-gray-900">Detail Pesanan Harian</h2>
            </div>
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-600">{{ $order->created_at->format('H:i') }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
            ...
            @else
                <div class="px-6 py-12 text-center">
                    ...
                    <p class="text-gray-600 text-lg font-semibold">Tidak ada pesanan pada tanggal ini</p>
                </div>
            @endif
        </div>
